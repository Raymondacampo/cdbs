  ...
  return (
    <div className="flex flex-col bg-pink md:pt-12 overflow-hidden">
      <Class
        ...
        position: "absolute -right-[25%] bottom-0 sm:-right-[15%] md:bottom-1 md:-rotate-1 md:right-0 lg:relative lg:translate-y-[8.3%] xl:translate-y-[8%]" }}
        ...
        age={{ age: "2.5 - 5 años", icon: <span>👶</span> }}
        order="first"
      ...
      <Class
        ...
        age={{ age: "6 - 7 años", icon: <span>👶</span> }}
        order="second"
      ...
      <Class
        phone="text-white max-w-[80%] mt-[4dvh] xl:mt-8"
        desktop="md:text-white md:max-w-[65%] md:top-4 md:mr-8"
        img={{ src: balletI, width: "w-[50dvw] h-auto max-w-[280px] md:w-[30dvh] lg:h-[49dvh] lg:w-auto xl:h-[50.5dvh]", 
        position: "absolute -right-[18%] sm:-right-[10%] bottom-0 md:-bottom-2 md:-rotate-1 md:right-[5%] md:bottom-1 lg:-left-8 lg:translate-y-[10.8%] lg:relative" }}
        bannercolor="bg-peach"
        bg="bg-pink"
        dayTime={{ dayTimes: [
          { day: "Lunes y Miercoles", time: "3:30pm - 4:30pm" },
      ...
      <div className="relative pb-8 bg-pink">
        <Class
          ...
          bg="bg-pink"
          dayTime={{ dayTimes: [
            { day: "Martes y Jueves", time: "3:30pm - 5:00pm" },
          ] }}
        ...
        <Class
          ...
          bg="bg-pink"
          dayTime={{ dayTimes: [
            { day: "Martes y Jueves", time: "4:30pm - 6:00pm" },
          ] }}
