...
export default function DashboardPage() {
  return (
    <div className="min-h-[80vh]">
      {/* Hero section */}
      <section className="bg-blush py-24 min-h-[70dvh] px-4 relative text-center shadow-xl mb-8">
      <InclineDiv variant="right" color="pink" size="lg" className="xl:pl-80 text-start z-10">LAS MAS<br></br> PEQUEÑAS</InclineDiv>

        {/* TODO: replace with actual hero image */}
        <Image src={pequenas} alt="Dance hero" className="absolute bottom-0 md:right-0 xl:right-[20dvw] z-10 w-130" />
        <div className="absolute z-10 max-w-3xl text-left xl:left-80 bottom-10">
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="flex items-start justify-center">
          <div className="rounded-xl p-6 transition-shadow flex flex-col max-w-md items-center justify-end relative top-10">
            <Image src={recitallogo} alt={'Recital Logo'} className="w-110"/>
            <div className="flex flex-col items-end relative right-15">
              <p className="text-end">Visita la tienda con la mas amplia variedad de productos para la danza en santo domingo</p>
              <Button size="md" className="mt-4 ml-auto">
                Ver Tienda
              </Button>              
            </div>
          </div>
          <Image src={Gaynor} alt={'Gaynor'} className="w-80 mb-4 rotate-12"/>
        </div>
      </section>

      {/* About overview */}
      <section className="pt-16 mt-24 bg-pink flex">
        <div className="flex items-start max-w-7xl mx-auto px-4">
          <Image src={belkis} alt="Belkis Sandoval" className="w-130" />
          <div className=" bg-peach shadow-lg rounded-xl p-6 transition-shadow flex flex-col max-w-lg items-start justify-end relative">
